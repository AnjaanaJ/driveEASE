  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-background)] px-4 overflow-hidden">
      ...
      >
        ...
        <p className="test-slate-400 text-sm mb-6">Log in to continue to your dashboard</p>
        ...
        <div className="mb-4">
          <label className="block text-slate-300 mb-1 text-sm" htmlFor="email">
            Email
          </label>
          <input
            id="email"
        ...
        <div className="mb-6">
          <label className="block text-slate-300 mb-1 text-sm" htmlFor="password">
            Password
          </label>
          <input
            id="password"
