...
function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--color-background)]">
      <div className="relative flex-1 flex items-center justify-center px-4 py-8 bg-[var(--color-background)] px-4 overflow-hiden">
        ...
        <div className="relative w-full max-w-sm animate-slide-in-left">
          <form
