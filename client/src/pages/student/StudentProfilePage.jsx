...
import { getStudentByUserId, updateStudent } from "../../api/studentApi";
...
function StudentProfilePage() {
  ...
  if (error && !student) {
    return (
        ...
        <div className="max-w-md mx-auto mt-10 p-6 text-center">
          ...
          <a href="/student/register-profile" className="text-accent hover:underline">
  ...
  return (
      <div className="max-w-md mx-auto mt-10 mb-10 p-6 bg-surface border border-slate-700 rounded-lg shadow">
        <h1 className="text-2xl font-semibold mb-6 text-text-primary">My Profile</h1>
        ...
        {!editing ? (
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-text-primary">{student.coursePackage?.name || "—"}</p>
            </div>
